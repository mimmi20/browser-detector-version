...
final class VersionBuilderTest extends TestCase
{
    ...
    public static function providerDetectVersion(): array
    {
        return [
            ...
            ['Outlook/15.0 (15.0.4691.1000; MSI; x86)', ['Outlook\/[\d.]+ ?', 'Outlook'], '15', '0', '4691', 'stable', null, '15.0.4691.1000'],
            ['Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.1.20) Gecko/20081217 Firefox(2.0.0.20)', ['Firefox'], '2', '0', '0', 'stable', null, '2.0.0.20'],
            ['Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/1.1.1.0(29.0.1547.62) Safari/537.36', ['Chrome\/[\d.]+ ?', 'Chrome'], '29', '0', '1547', 'stable', null, '29.0.1547.62'],
